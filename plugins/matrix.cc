                        ...
                        const ClassifiedColumns & columns)
{
    ...
    parallelReduce(0, featureBuckets.size(), sortBucket);
               ...
               const FeatureBuckets & featureBuckets)
{
    ...
    parallelReduce(0, featureBuckets.size(), doBucket);
    ...
    parallelReduce(0, result.size(), sortIndex);
                      ...
                      int numBasisVectors)
{
    ...
    parallelReduce(0, featurePairs.size(), doCorrelation);
